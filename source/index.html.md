...
### 1. Analytics SDR
Requirement document for Adobe Analytics

### 2. Access to Ensighten
Please contact [adaqdev@turner.com](mailto:adaqdev@turner.com) for access

### 3. Adobe configuration values:
...
TBS Latin America | tbslatinamerica.2o7.net | tbslatinamerica
...
```javascript
<script type="text/javascript" src="//nexus.ensighten.com/turnerintl/new-space/Bootstrap.js"></script>
```
